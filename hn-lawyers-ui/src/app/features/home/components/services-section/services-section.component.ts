...
export class ServicesSectionComponent {
    services = [
        {
            ...
            description: `Công ty Luật HNLawyers Vietnam hỗ trợ nhiều vụ tố tụng Tòa án, tố tụng Trọng tài và đàm phán, thương lượng khác nhau. Chúng tôi cũng có kinh nghiệm trong vấn đề dân sự và thương mại nói chung, bao gồm thu hồi nợ và yêu cầu bồi thường thiệt hại. <br /> <br />
                    Công ty Luật HNLawyers Vietnam hỗ trợ nhiều vụ tố tụng Tòa án, tố tụng Trọng tài và đàm phán, thương lượng khác nhau. Chúng tôi cũng có kinh nghiệm trong vấn đề dân sự và thương mại nói chung, bao gồm thu hồi nợ và yêu cầu bồi thường thiệt hại.`,
        ...
        },
        {
            ...
            description: `Công ty Luật HNLawyers Vietnam cung cấp một danh mục đầy đủ các dịch vụ cho khách hàng đầu tư tất cả các lĩnh vực trên khắp lãnh thổ Việt Nam, bao gồm công nghiệp (như là sản xuất và chế biến), nông nghiệp và nuôi trồng thủy sản và dịch vụ (như là vận tải, viễn thông, khách sạn, du lịch và cơ sở hạ tầng thể thao, ngân hàng và tài chính, văn hóa, y tế và giáo dục, khu dân cư, công trình thương mại và xây dựng kết cấu hạ tầng).`,
        ...
        },
        {
            ...
            description: `Công ty Luật HNLawyers Vietnam có kinh nghiệm phong phú về việc tư vấn cho khách hàng doanh nghiệp về các vấn đề lao động và việc làm. Chúng tôi cũng có kinh nghiệm trong việc bảo vệ người lao động khi đại diện cho họ trong việc thương lượng với người sử dụng lao động của họ về vấn đề chấm dứt quan hệ lao động trái luật và trước tòa án giải quyết tranh chấp liên quan đến lao động.`,
        ...
        },
        {
            ...
            description: `HNLawyers Vietnam có các luật sư chuyên nghiệp chuyên tư vấn các vấn đề bảo vệ dữ liệu, từ thu thập, xử lý, lưu trữ và chuyển giao thông tin cá nhân đến hỗ trợ khách hàng về các vấn đề tuân thủ quy định.`,
        ...
        },
        {
            ...
            description: `HNLawyers Vietnam có một đội ngũ luật sư có kinh nghiệm về sáng chế, nhãn hiệu, thiết kế, có trình độ và kỹ năng xử lý toàn bộ các dịch vụ pháp lý liên quan đến sở hữu trí tuệ tại Việt Nam. Chúng tôi hỗ trợ khách hàng trong tất cả các bước của giai đoạn quản lý quyền sở hữu trí tuệ.`,
        ...
        },
        {
            ...
            title: 'Lĩnh vực khác',
            description: `Công ty Luật HNLawyers Vietnam có kinh nghiệm phong phú trong các lĩnh vực sau: giáo dục, bảo hiểm, kinh doanh mỹ phẩm, tên miền, thương mại quốc tế, sở hữu trí tuệ, khoa học đời sống và chăm sóc sức khỏe, vận chuyển hàng hóa, thuế, viễn thông, truyền thông và công nghệ (TMT), Dịch vụ luật sư tư vấn thường xuyên (hàng tháng/ hàng năm).`,
    ...
    selectService(index: number) {
        console.log('Selected service index:', index);
